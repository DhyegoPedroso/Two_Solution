...
public class PlanejamentoControle implements Serializable {
    ...
    public void visualizarUsuario(){
        ...
        try {
            abreSessao();
            planejamento = planejamentoDao.pesquisarPorUsuarioPlanejamento(planejamento.getUsuario(), sessao);
            modelPlanejamentos = new ListDataModel(planejamento.getAtividades());
            planejamento.setNome(null);
        } catch (Exception e) {
            System.out.println("erro ao pesquisar Planejamento por nome: " + e.getMessage());
        } finally {
