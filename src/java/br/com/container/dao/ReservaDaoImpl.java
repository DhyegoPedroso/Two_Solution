...
public class ReservaDaoImpl extends BaseDaoImpl<Reserva, Long> implements ReservaDao {
    ...
    public static void main(String[] args) {
        ...
        List todas = daoImpl.totalMesSalas(session);
    ...
    @Override
    public List<GraficoReservaPorTotalMesSala> totalMesSalas(Session session) throws HibernateException {
        Object[] item;
        GraficoReservaPorTotalMesSala grt;
         List<GraficoReservaPorTotalMesSala> todosGrts = new ArrayList<>();
        Query consulta = session.createQuery("select month(inicio) as mes, count(id) as total "
        ...
        for (Object resultado : resultados) {
            ...
            grt = new GraficoReservaPorTotalMesSala((int) item[0], (long) item[1]);
            todosGrts.add(grt);
